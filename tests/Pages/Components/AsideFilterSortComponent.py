...
class AsideFilterSortComponent(BasePage):
    ...
    element_locators = {
            ...
            'filter_sort_close_icon': AsideFilterSortComponentLocators.FILTER_SORT_CLOSE_ICON,
            'no_search_result_title': AsideFilterSortComponentLocators.NO_SEARCH_RESULT_TITLE
            }
